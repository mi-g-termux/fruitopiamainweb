 ...
 *
 *  1. /firebase-config.json or /public/firebase-config.json
 *                            — runtime file fetched from the public web root.
 *                              Supports both normal builds (public files copied
 *                              to web root) and cPanel/source installs where
 *                              the file lives at public_html/public/.
 ...
 */
const FIREBASE_CONFIG_URLS = ['/firebase-config.json', '/public/firebase-config.json'];
