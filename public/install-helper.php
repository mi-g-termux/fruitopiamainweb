 ...
 * writes firebase-config.json to the public folder that serves this helper, then
...
if ($writeResult === false) {
    respond(
        false,
        'Failed to write firebase-config.json. Check that the web server has write permission to the public folder (for cPanel source installs: public_html/public). ' .
...
// ── Success ──────────────────────────────────────────────────────────────────
respond(true, 'Firebase configuration saved successfully. firebase-config.json written beside install-helper.php in the public folder.');
